...
public class FSM_1003 : MonoBehaviour
{
    ...
    private void Start()
    {
        states.Add(State.Idle, new IdleState_1003(this));
        states.Add(State.Attack, new AttackState_1003(this));
        // states.Add(State.Stop, new StopState_1003(this));
